...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='./pretrian/yolov4-p7.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/eus.yaml', help='data.yaml path')
